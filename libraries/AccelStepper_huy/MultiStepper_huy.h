...
/////////////////////////////////////////////////////////////////////
/// \class MultiStepper_huy MultiStepper_huy.h <MultiStepper_huy.h>
...
/// All the steppers managed by MultiStepper_huy will step at a constant speed to their
/// target (albeit perhaps different speeds for each stepper).
class MultiStepper_huy
{
public:
    /// Constructor
    MultiStepper_huy();
    ...
    boolean addStepper(AccelStepper_huy& stepper);
...
private:
    ...
    AccelStepper_huy* _steppers[MULTISTEPPER_MAX_STEPPERS];
...
/// @example MultiStepper_huy.pde
/// Use MultiStepper_huy class to manage multiple steppers and make them all move to 
