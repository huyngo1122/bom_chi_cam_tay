// AccelStepper_huy.h
//
/// \mainpage AccelStepper_huy library for Arduino
///
/// This is the Arduino AccelStepper_huy library.
...
///
/// AccelStepper_huy significantly improves on the standard Arduino Stepper library in several ways:
...
/// http://www.airspayce.com/mikem/arduino/AccelStepper_huy
/// The version of the package that this documentation refers to can be downloaded 
/// from http://www.airspayce.com/mikem/arduino/AccelStepper_huy/AccelStepper_huy-1.59.zip
///
...
/// with the exception that AccelStepper_huy uses steps per second rather than radians per second
...
///
/// \htmlonly <form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input type="hidden" name="cmd" value="_donations" /> <input type="hidden" name="business" value="mikem@airspayce.com" /> <input type="hidden" name="lc" value="AU" /> <input type="hidden" name="item_name" value="Airspayce" /> <input type="hidden" name="item_number" value="AccelStepper_huy" /> <input type="hidden" name="currency_code" value="USD" /> <input type="hidden" name="bn" value="PP-DonationsBF:btn_donateCC_LG.gif:NonHosted" /> <input type="image" alt="PayPal — The safer, easier way to pay online." name="submit" src="https://www.paypalobjects.com/en_AU/i/btn/btn_donateCC_LG.gif" /> <img alt="" src="https://www.paypalobjects.com/en_AU/i/scr/pixel.gif" width="1" height="1" border="0" /></form> \endhtmlonly
/// 
/// \par Trademarks
///
/// AccelStepper_huy is a trademark of AirSpayce Pty Ltd. The AccelStepper_huy mark was first used on April 26 2010 for
...
///               specifying AccelStepper_huy::FULL4WIRE and friends.
...
/// \version 1.43  Added DualMotorShield example. Shows how to use AccelStepper_huy to control 2 x 2 phase steppers using the 
...
///                Added new method maxSpeed() to AccelStepper_huy to return the currently configured maxSpeed.<br>
...
///                AccelStepper_huy::disableOutputs now sets the enable pion to OUTPUT mode if the enable pin is defined.
...
///                Improvements to efficiency of AccelStepper_huy::runSpeed() as suggested by David Grayson.
...
// $Id: AccelStepper_huy.h,v 1.27 2016/08/14 10:26:54 mikem Exp mikem $
...
/////////////////////////////////////////////////////////////////////
/// \class AccelStepper_huy AccelStepper_huy.h <AccelStepper_huy.h>
...
/// AccelStepper_huy will not have a correct 
...
class AccelStepper_huy
{
public:
    /// \brief Symbolic names for number of pins.
    /// Use this in the pins argument the AccelStepper_huy constructor to 
    ...
    /// AccelStepper_huy::DRIVER (1) means a stepper driver (with Step and Direction pins).
    /// If an enable line is also needed, call setEnablePin() after construction.
    /// You may also invert the pins using setPinsInverted().
    /// AccelStepper_huy::FULL2WIRE (2) means a 2 wire stepper (2 pins required). 
    /// AccelStepper_huy::FULL3WIRE (3) means a 3 wire stepper, such as HDD spindle (3 pins required). 
    /// AccelStepper_huy::FULL4WIRE (4) means a 4 wire stepper (4 pins required). 
    /// AccelStepper_huy::HALF3WIRE (6) means a 3 wire half stepper, such as HDD spindle (3 pins required)
    /// AccelStepper_huy::HALF4WIRE (8) means a 4 wire half stepper (4 pins required)
    /// Defaults to AccelStepper_huy::FULL4WIRE (4) pins.
    /// \param[in] pin1 Arduino digital pin number for motor pin 1. Defaults
    /// to pin 2. For a AccelStepper_huy::DRIVER (interface==1), 
    /// this is the Step input to the driver. Low to high transition means to step)
    /// \param[in] pin2 Arduino digital pin number for motor pin 2. Defaults
    /// to pin 3. For a AccelStepper_huy::DRIVER (interface==1), 
    ...
    AccelStepper_huy(uint8_t interface = AccelStepper_huy::FULL4WIRE, uint8_t pin1 = 2, uint8_t pin2 = 3, uint8_t pin3 = 4, uint8_t pin4 = 5, bool enable = true);
    ...
    AccelStepper_huy(void (*forward)(), void (*backward)());
    ...
    /// The target position in steps. The AccelStepper_huy library will move the
...
/// Shows how to run AccelStepper_huy in the simplest,
...
/// Shows how to use AccelStepper_huy to control a 3-phase motor, such as a HDD spindle motor
/// using the Adafruit Motor Shield http://www.ladyada.net/make/mshield/index.html.

/// @example DualMotorShield.pde
/// Shows how to use AccelStepper_huy to control 2 x 2 phase steppers using the 
